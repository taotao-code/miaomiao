<template>
 <div class="foot-btn" >
	  <ul>
	   <router-link tag="li" class="home"active-class="active" to="/home"><a href="javascript;" ></a></router-link>
	     <router-link tag="li" class="write"active-class="active" to="/lalal"><a href="javascript;" ></a></router-link>
		 <router-link tag="li" class="my"active-class="active" to="/user"><a href="javascript;" ></a></router-link>
   </ul>
 </div>
</template>
